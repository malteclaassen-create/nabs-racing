...
const ICONS = {
  ...
  // Steam is deliberately NOT in SOCIAL_META below: it is an identity we store
  // for result matching, not a link a driver publishes. Adding it there would
  // put a Steam field into the public per-driver link editor, where the backend
