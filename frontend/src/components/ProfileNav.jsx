...
//
// A pixel larger than the line icons, because a filled mark reads smaller than
// an outline at the same box. Its light-mode contrast is TokenIcon's own
// business now, for every place the mark appears rather than just this row.
const TOKEN_MARK = "h-[18px] w-[18px]";
