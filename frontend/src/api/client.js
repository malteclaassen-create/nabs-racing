...
export const api = {
  ...
  // A page's own link-preview title/description (blank = automatic).
  saveSeriesShareText: (id, page, body) =>
    request(`/admin/series/${id}/share-text/${page}`, { method: "PUT", body, auth: true }),
