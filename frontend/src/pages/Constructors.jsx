...
function TierBlock({ id, tier, standings, teams, title, championTeamId, decided = false, showMovement = false }) {
  ...
  return (
    <section id={id} className="reveal scroll-mt-28 space-y-6">
      ...
      <StandingsTable variant="constructor" raceNumbers={standings.raceNumbers} sprintRounds={standings.sprintRounds || []} fastestLapPoints={standings.fastestLapPoints || 0} pointsMultipliers={standings.pointsMultipliers || {}} rows={rows} dropWorst={standings.dropWorst} officialTotals={standings.officialTotals} dropMode={standings.dropMode} teamDropWorst={standings.teamDropWorst} decided={decided} showMovement={showMovement} />
